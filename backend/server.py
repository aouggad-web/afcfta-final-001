...
async def get_economic_news(
    ...
    try:
        ...
        logger.error(f"Erreur récupération actualités: {e}")
        return {
            "success": False,
            "error": str(e),
            "articles": []
...
async def get_news_grouped_by_region(force_refresh: bool = Query(False)):
    ...
    try:
        ...
        logger.error(f"Erreur récupération news par région: {e}")
        return {"success": False, "error": str(e)}
...
async def get_news_grouped_by_category(force_refresh: bool = Query(False)):
    ...
    try:
        ...
        logger.error(f"Erreur récupération news par catégorie: {e}")
        return {"success": False, "error": str(e)}
