...
# HS Product Names (French/English)
HS_PRODUCT_NAMES = {
    ...
    "71": {"fr": "Pierres précieuses, métaux précieux", "en": "Precious stones, metals"},
    "7108": {"fr": "Or", "en": "Gold"},
    ...
    "18": {"fr": "Cacao et ses préparations", "en": "Cocoa and preparations"},
